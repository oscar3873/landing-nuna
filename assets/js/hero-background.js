...
d.addEventListener("DOMContentLoaded", (e) => {
    ...
    const heroPathImgArr = ["assets/img/background1.jpg", "assets/img/background2.jpg", "assets/img/background3.jpg", "assets/img/background4.jpg", "assets/img/background5.jpg", "assets/img/background6.jpg"];
